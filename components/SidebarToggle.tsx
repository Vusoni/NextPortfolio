...
function SidebarToggle() {
  ...
  const isSidebarOpen = isMobile ? openMobile : open; // If User is on Mobile then openMobile, otherwise desktop

  if (isSidebarOpen) return null; // If it's open then return nothing
