...
export const structure: StructureResolver = (S) =>
  S.list()
    ...
    .items([
      ...
      // Professional Section Background with work and education experience, skills etc.
      S.listItem()
      ...
      // Content & Community Section with blog posts and testimonials
      S.listItem()
      ...
      // Contact Form Submissions Section with new and archived submissions
      S.listItem()
      ...
      // Navigation Section with navigation links
      S.listItem()
      ...
      // Site Settings (Singleton) Settings for the site like the title, description, keywords etc.
      S.listItem()
        .title("Site Settings")
        .icon(CogIcon)
        .child(
